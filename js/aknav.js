...
$(document).ready(function(){
    ...
    // console.log(reg)
    let html = `
    <img src="./image/custom/texas.jpg" width="40" height="40" style="transform:scale(1.2,1.2)translate(-8px,1px)"class="d-inline-block align-top" alt="">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown" id="navitemRegion">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item reg selectable" onclick="regDropdown($(this))" value="en">English</a>
